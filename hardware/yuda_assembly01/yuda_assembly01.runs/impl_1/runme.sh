...
EAStep vivado -log program_loader_processor_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source program_loader_processor_test.tcl -notrace
